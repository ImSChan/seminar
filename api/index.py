...
def dooray_commands():
    payload = {
        "responseType": "ephemeral",      # 먼저 사용자에게만 보이게
        ...
        "attachments": [
            {
                ...
                "actions": [
                    {"name": "pick", "type": "button", "text": "1", "value": "pick|6|409486075||1", "style": "default"},
                    {"name": "pick", "type": "button", "text": "2", "value": "pick|6|409486075||2", "style": "default"},
                    {"name": "pick", "type": "button", "text": "3", "value": "pick|6|409486075||3", "style": "default"}
                ]
            },
            {
                "callbackId": "tarot-pick",
                "actions": [
                    {"name": "pick", "type": "button", "text": "4", "value": "pick|6|409486075||4", "style": "default"},
                    {"name": "pick", "type": "button", "text": "5", "value": "pick|6|409486075||5", "style": "default"},
                    {"name": "pick", "type": "button", "text": "6", "value": "pick|6|409486075||6", "style": "default"}
                ]
            },
            {
                "callbackId": "tarot-pick",
                "actions": [
                    {"name": "reset", "type": "button", "text": "🔄 다시 선택", "value": "reset|6|409486075||연애운", "style": "default"},
                    {"name": "fill",  "type": "button", "text": "🎲 무작위로 채우기", "value": "fill|6|409486075||연애운",  "style": "default"}
                ]
            }
        ]
    }
